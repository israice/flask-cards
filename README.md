...
- SSE strwam data/auth_cards.csv to templates\table.html
- adding Navbar with buttons
- allow table button only to admins from admin_db.csv
...
git add .
git commit -m "v1.008 - checking auto update on ubuntu server side from github webhook test6"
git push
